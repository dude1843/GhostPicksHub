...
const DEFAULT_CAPPERS = [
  { name: 'Benny', title: "Your Capper's Favorite Capper", sports: 'NBA • NHL • NFL • NCAAB • NCAAF • Soccer • MLB', wins: 0, losses: 0, rank: 1 },
  { name: 'Juice AI', title: 'AI-Powered Sports Analysis', sports: 'MLB • NBA • College Basketball', wins: 0, losses: 0, rank: 2 },
  { name: 'Jimmy', title: 'Founder & CEO', sports: 'MLB • NBA • NHL • Soccer • WNBA', wins: 0, losses: 0, rank: 3 },
];
...
const styles = StyleSheet.create({
  ...
  seasonText: { color: GOLD, fontSize: 13, fontFamily: 'Inter_700Bold', letterSpacing: 1 },
  ...
  sectionLabel: { color: '#FFF', fontSize: 12, fontFamily: 'Inter_700Bold', letterSpacing: 1.5 },
  capperCard: {
  ...
  rankText: { color: GOLD, fontSize: 12, fontFamily: 'Inter_700Bold' },
  ...
  capperInfo: { flex: 1 },
  capperName: { color: '#FFF', fontSize: 15, fontFamily: 'Inter_700Bold' },
  capperTitle: { color: GOLD, fontSize: 10, fontFamily: 'Inter_400Regular', marginTop: 2 },
  capperSports: { color: '#666', fontSize: 10, fontFamily: 'Inter_400Regular', marginTop: 3 },
  capperStats: { alignItems: 'flex-end' },
  statValue: { color: '#FFF', fontSize: 14, fontFamily: 'Inter_700Bold' },
  winRate: { color: GOLD, fontSize: 14, fontFamily: 'Inter_700Bold', marginTop: 4 },
  statLabel: { color: '#666', fontSize: 10, fontFamily: 'Inter_400Regular' },
  ...
  statBoxValue: { color: '#FFF', fontSize: 22, fontFamily: 'Inter_700Bold' },
  statBoxLabel: { color: '#666', fontSize: 11, fontFamily: 'Inter_400Regular', textAlign: 'center' },
  disclaimer: {
    color: '#444', fontSize: 11, textAlign: 'center',
    marginHorizontal: 24, lineHeight: 18, fontFamily: 'Inter_400Regular',
  },
});