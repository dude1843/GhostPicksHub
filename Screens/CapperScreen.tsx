...
const styles = StyleSheet.create({
  ...
  header: { color: GOLD, fontSize: 13, letterSpacing: 3, fontFamily: 'Inter_600SemiBold' },
  card: {
  ...
  title: { color: GOLD, fontSize: 11, fontFamily: 'Inter_400Regular', marginBottom: 2 },
  handle: { color: '#555', fontSize: 11, fontFamily: 'Inter_400Regular', marginBottom: 10 },
  statsRow: { flexDirection: 'row', marginBottom: 10, gap: 14 },
  stat: { alignItems: 'center' },
  statValue: { color: GOLD, fontFamily: 'Inter_700Bold', fontSize: 14 },
  statLabel: { color: '#555', fontSize: 10, fontFamily: 'Inter_400Regular' },
  ...
  sportTagText: { color: GOLD, fontSize: 10, fontFamily: 'Inter_700Bold' },
  ...
  modalHeaderTitle: { color: '#FFF', fontSize: 16, fontFamily: 'Inter_700Bold', letterSpacing: 1 },
  ...
  modalName: { color: '#FFF', fontSize: 26, fontFamily: 'Inter_700Bold' },
  modalTitle: { color: GOLD, fontSize: 13, fontFamily: 'Inter_400Regular', marginTop: 2 },
  modalHandle: { color: '#888', fontSize: 12, fontFamily: 'Inter_400Regular', marginTop: 2 },
  modalStatsRow: {
  ...
  modalStatValue: { color: GOLD, fontFamily: 'Inter_700Bold', fontSize: 20 },
  modalStatLabel: { color: '#666', fontSize: 11, fontFamily: 'Inter_400Regular', marginTop: 2 },
  section: { padding: 20 },
  sectionTitle: {
    color: GOLD, fontSize: 11, fontFamily: 'Inter_700Bold',
    letterSpacing: 2, marginBottom: 10, marginTop: 4,
  },
  bioText: {
    color: '#AAA', fontSize: 14, lineHeight: 22,
    marginBottom: 20, fontFamily: 'Inter_400Regular',
  },
  vipBanner: {
    flexDirection: 'row', alignItems: 'center',
  ...
  vipBannerTitle: { color: BLACK, fontSize: 14, fontFamily: 'Inter_700Bold' },
  vipBannerSub: { color: BLACK, fontSize: 11, fontFamily: 'Inter_400Regular', marginTop: 2, opacity: 0.8 },
  disclaimer: {
    color: '#333', fontSize: 11, textAlign: 'center',
    marginTop: 10, fontFamily: 'Inter_400Regular',
  },
});