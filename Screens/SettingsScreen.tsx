...
const styles = StyleSheet.create({
  ...
  headerTitle: { color: '#FFF', fontSize: 20, fontFamily: 'Inter_600SemiBold', letterSpacing: 0.3 },
  sectionRow: {
    flexDirection: 'row', alignItems: 'center',
    marginHorizontal: 16, marginBottom: 10, gap: 8,
  },
  sectionLabel: { color: GOLD, fontSize: 11, fontFamily: 'Inter_700Bold', letterSpacing: 1.5 },
  section: {
  ...
  disclaimerCard: {
    marginHorizontal: 16, backgroundColor: CARD, borderRadius: 16,
    padding: 16, marginBottom: 24, borderWidth: 1, borderColor: '#2A2A2A', alignItems: 'center',
  },
  disclaimerText: {
    color: '#666', fontSize: 12, textAlign: 'center',
    lineHeight: 20, fontFamily: 'Inter_400Regular',
  },
  version: { color: '#333', fontSize: 11, textAlign: 'center', marginBottom: 20, fontFamily: 'Inter_400Regular' },
});