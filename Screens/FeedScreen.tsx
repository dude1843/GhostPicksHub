...
const styles = StyleSheet.create({
  ...
  loadingText: { color: GOLD, fontSize: 14, fontFamily: 'Inter_400Regular' },
  emptyContainer: { alignItems: 'center', marginTop: 60, gap: 8 },
  emptyText: { color: '#FFF', fontSize: 16, fontFamily: 'Inter_700Bold' },
  emptySubText: { color: '#555', fontSize: 13, fontFamily: 'Inter_400Regular' },
  ...
  avatarText: { color: BLACK, fontFamily: 'Inter_700Bold', fontSize: 16 },
  capperName: { color: '#FFF', fontSize: 15, fontFamily: 'Inter_700Bold', letterSpacing: 0.5 },
  handle: { color: '#555', fontSize: 12, fontFamily: 'Inter_400Regular' },
  sportBadge: { backgroundColor: '#1E1E1E', borderRadius: 6, paddingHorizontal: 10, paddingVertical: 4, borderWidth: 1, borderColor: '#333' },
  sportText: { color: GOLD, fontSize: 11, fontFamily: 'Inter_700Bold', letterSpacing: 1 },
  promoBadge: { backgroundColor: GOLD, borderRadius: 6, paddingHorizontal: 10, paddingVertical: 4 },
  promoText: { color: BLACK, fontSize: 10, fontFamily: 'Inter_700Bold', letterSpacing: 1 },
  confidence: { fontSize: 11, fontFamily: 'Inter_600SemiBold', letterSpacing: 1, marginBottom: 8 },
  postContent: { color: '#DDD', fontSize: 14, lineHeight: 22, marginBottom: 8, fontFamily: 'Inter_400Regular' },
  time: { color: '#444', fontSize: 11, marginBottom: 14, fontFamily: 'Inter_400Regular' },
  ...
  voteText: { color: '#888', fontFamily: 'Inter_700Bold', fontSize: 13, letterSpacing: 1 },
